...
## [17/07/2026 19:01] Limpeza: Merge dos 12 pares de contatos duplicados no WhatsApp
- **O que foi feito:** Executado o merge real no banco de produção dos 12 pares de contatos duplicados em `whatsapp_conversations` que existiam em razão da inconsistência do 9º dígito do celular BR (ex: `558184433272` vs `5581984433272`). Para cada par: (1) mensagens movidas da conversa duplicada para a principal; (2) tags unidas (array distinct); (3) telefone da conversa principal atualizado para o formato canônico de 13 dígitos; (4) mensagem interna de aviso inserida nos 5 pares com conflito de vendedor (pares 3, 4, 9, 10, 12); (5) conversa duplicada deletada. **12/12 pares concluídos com sucesso.** Esta operação foi possível graças à correção prévia da função `normalizarTelefoneBR()` que previne novos duplicados na origem.
- **Pares mesclados:** (1) Aleixo: 558173→5581973224553 | (2) Andrea Lins: 558181→5581981464421 | (3) Marcos Aurélio: 558184→5581984433272 | (4) Diego Santos: 558186→5581986886347 | (5) Ale Oliveira: 558188→5581988133105 | (6) Vilma Rago: 558191→5581991702147 | (7) Luiz Carlos: 558197211→5581997211420 | (8) Francisco: 558197551→5581997551259 | (9) A.T/Arthur: 558198083→5581998083832 | (10) Avani: 558198402→5581998402639 | (11) Sergio Falcão: 558198804→5581998804791 | (12) Emanoell: 556499→5564999242258
- **Arquivos modificados:** `api/index.ts` (execução via scripts em `scratch/`)
